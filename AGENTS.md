...
- Keep this repo limited to genuinely cross-product primitives: tokens, base styles, canonical public header/footer behavior, theme/menu behavior, and shared brand assets.
